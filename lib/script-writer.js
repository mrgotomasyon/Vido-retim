...
KURALLAR:
- Metni doğal konuşma diline dönüştür, ama ASLA mevcut yapıyı bozma
...
- "AI" kelimesini "A I" (iki ayrı harf, aralarında boşluk) olarak yaz — TTS harfleri ayrı ayrı söylesin
- Yabancı kelimeleri Türkçe okunuşuyla yaz: örn. "SEO" → "S E O", "GEO" → "G E O"
- Emoji, ok işareti (→), URL dışında sembol KULLANMA
- Doğal duraklamalar için nokta ve virgül kullan — ünlem işaretini az kullan (TTS'i bozar)
...
ÖRNEK ÇIKTI FORMAT:
A I tabanlı büyüme başladı. Rakiplerin öneriliyor olabilir. Siz hâlâ sadece arama sonuçlarında mısınız? A I çağında görünmek yetmez, önerilmek zorundasınız. Yüzde beş ile on beş daha fazla A I trafiği sağlayın ve beş kat daha fazla önerilme şansı yakalayın. Hemen ücretsiz A I analizinizi alın ve zirveye tırmanın. Algeonex.com.`;
