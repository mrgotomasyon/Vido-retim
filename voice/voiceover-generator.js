...
async function generateWithKieTTS({ text, outputPath, apiKey }) {
  const createResp = await axios.post(
    `${KIE_BASE}/createTask`,
    {
      ...
      input: {
        text,
        voice:            "tnSpp4vdxKPjI9w0GnoV",  // custom voice ID — expressive Turkish ad tone
        stability:        0.45,       // slightly expressive, natural variation
        similarity_boost: 0.80,       // high clarity
        style:            0.70,       // strong style — motivation/confidence emotion
        speed:            0.95,       // 0.95 — professional Turkish ad pace, clear and confident
        language_code:    "tr"        // Turkish pronunciation
      }
    },
    {
      headers: {
